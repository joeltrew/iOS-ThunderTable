...
public struct AnyInputRow: InputRow {
	...
	public var valueChangeHandler: ValueChangeCallback?
	
	
	private let _accessoryType: () -> UITableViewCellAccessoryType?
	private let _selectionStyle: () -> UITableViewCellSelectionStyle?
	private let _cellStyle: () -> UITableViewCellStyle?
	...
	private let _selectionHandler: () -> SelectionHandler?
	private let _editHandler: () -> EditHandler?
	...
	init<T: Row>(base: T) {
		...
		_accessoryType = { base.accessoryType }
		_selectionStyle = { base.selectionStyle }
		_cellStyle = { base.cellStyle }
		_title = { base.title }
		_subtitle = { base.subtitle }
		_image = { base.image }
		_imageSize = { base.imageSize }
		_imageURL = { base.imageURL }
		_remainSelected = { base.remainSelected }
		_displaySeparators = { base.displaySeparators }
		_isEditable = { base.isEditable }
		_cellClass = { base.cellClass }
		_prototypeIdentifier = { base.prototypeIdentifier }
		_selectionHandler = { base.selectionHandler }
		_editHandler = { base.editHandler }
		_estimatedHeight = { base.estimatedHeight }
		_padding = { base.padding }
		_useNibSuperclass = { base.useNibSuperclass }
	}
	...
	public var remainSelected: Bool {
		get { return _remainSelected() }
	}
	
	public var displaySeparators: Bool {
		get { return _displaySeparators() }
	}
	...
	public var prototypeIdentifier: String? {
		get { return _prototypeIdentifier() }
	}
